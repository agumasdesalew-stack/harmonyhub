    ...
    return (
      <div className="h-24 bg-black border-t border-gray-900 flex items-center justify-center flex-shrink-0">
        <div className="flex items-center justify-center space-x-6">
          ...
          <button className="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center hover:bg-yellow-400 transition-colors">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-2 flex items-center space-x-2 text-xs text-gray-600">
          <span>0:00</span>
  ...
  return (
    <div className="h-24 bg-black border-t border-gray-900 px-6 flex items-center justify-between relative flex-shrink-0">
      ...
      <div className="flex items-center space-x-4 flex-1 justify-end">
        ...
        >
          {/** mute/unmute icon */}
          {/** showing different icon depending on muted state */}
          {/** destructured from context earlier */}
          {
            muted ? (
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5v14l11-7L9 5zM2 9v6" />
              </svg>
            ) : (
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5l6 7-6 7V5zM2 9v6" />
              </svg>
            )
          }
        </button>
